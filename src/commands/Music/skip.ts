...
import type { LavalinkDispatcher } from '../../structures/Music/LavalinkDispatcher';
...
export class UserCommand extends Command {
	public async messageRun(message: Message) {
		const $DISPATCHER: LavalinkDispatcher = this.container.client.queue.get(message.guild?.id!)!;
